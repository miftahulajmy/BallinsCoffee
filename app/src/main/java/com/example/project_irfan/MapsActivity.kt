...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val Ballins = LatLng( 0.511965116669, 101.437293883)
        mMap.addMarker(
            MarkerOptions().position(Ballins)
                .title("BALLINS COFFEE")
        )
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Ballins, 12F))
